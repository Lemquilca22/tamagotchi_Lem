...
4. Antes de ir al apartado principal nos preguntará si queremos modificar algo de nuestro tamagotchi, si la respuesta es SI, volveremos a personalizar a nuestra mascota, de otra modo continuaremos y empezaremos a jugar.
5. Ahora empezamos a jugar, se mostrará el nombre de tu tamagotchi, su aspecto y sus estadisticas iniciales que son todos en base 5. (dinero=5, felicidad=5, energia=5, dinero=5)
